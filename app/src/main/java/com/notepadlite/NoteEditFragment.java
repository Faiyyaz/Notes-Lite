...
public class NoteEditFragment extends Fragment {
    ...
    IntentFilter filter = new IntentFilter("com.notepadlite.DELETE_NOTES");
    ...
    // Saves notes to /data/data/com.notepadlite/files
    ...
    public void onDeleteDialogPositiveClick() {
        ...
        if(getActivity().getComponentName().getClassName().equals("com.notepadlite.MainActivity")
                && getActivity().findViewById(R.id.layoutMain).getTag().equals("main-layout-large")) {
